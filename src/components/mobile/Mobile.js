        ...
        <div className={classes.mobile__left}>
            <div className={classes.mobile__title}>
                ...
                <div className={classes.mobile__text}>
                    <p>Получите доступ к нашей полной библиотеке тренировок в любое время и в любом месте — дома, в тренажерном зале и в пути.</p>
                    <div className={classes.icons}>
                        <a className={classes.btn} href="#">CКАЧАТЬ</a>
